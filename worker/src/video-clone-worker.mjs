...
- REAL PRODUCT SCALE — the product must appear at its TRUE real-world size and proportion relative to the hand and face: a small handheld device stays small, held naturally between the fingers. Get it readable by bringing it CLOSE to the camera, NOT by enlarging the product itself. Never stretch, inflate or exaggerate its size — an oversized, out-of-proportion product looks fake.
