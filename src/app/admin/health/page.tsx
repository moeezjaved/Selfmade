          ...
          >
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 12 }}>
              ...
              <KPI
                ...
                sub={data.classify?.done != null && data.classify?.classifiable != null ? `${data.classify.done.toLocaleString()} / ${data.classify.classifiable.toLocaleString()}` : undefined}
                tone={(data.classify?.pct_done ?? 0) >= 95 ? 'good' : 'neutral'}
                hint="Share of classifiable ads (real body text) that E has fully tagged (hooks + topics). 100% = classification caught up." />
            </div>
          </Section>
