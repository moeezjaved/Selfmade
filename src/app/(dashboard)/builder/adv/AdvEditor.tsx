...
const SECTION_LIBRARY: { id: string; label: string; html: string }[] = [
  ...
  { id: 'reviews', label: 'Featured Reviews Carousel', html: slWrap(slHead('What our community is saying', 'Join thousands of people loving the feeling of truly fresh, healthy hair.') + `<div class="frcar" style="position:relative;max-width:640px;margin:0 auto"><div class="frtrack" style="display:flex;gap:16px;overflow-x:auto;scroll-snap-type:x mandatory;scrollbar-width:none">${([['Sarah M.', 'Honestly the best I have tried — I noticed a difference within days. My hair has never felt this light and clean.'], ['James T.', 'Worth every penny. Repurchasing for the third time now — it has become part of my weekly routine.'], ['Aisha K.', 'Gentle, effective, and it actually works. Highly recommend it to anyone on the fence.']] as [string, string][]).map(([n, q]) => `<div class="frcard" style="scroll-snap-align:center;flex:0 0 100%;box-sizing:border-box;background:#fff;border:1px solid ${SL_LINE};border-radius:18px;padding:30px 28px;box-shadow:0 4px 18px -10px rgba(20,18,15,.2)"><div class="stars" style="color:#f5a623;letter-spacing:2px;font-size:17px;margin-bottom:14px">★★★★★</div><p class="frq" style="font-size:16.5px;line-height:1.6;color:${SL_INK};margin:0 0 18px">"${q}"</p><div class="frwho" style="display:flex;align-items:center;gap:12px"><span class="avim" style="width:46px;height:46px;border-radius:50%;overflow:hidden;flex:none"><img src="${SL_AVATAR}" alt="" style="width:100%;height:100%;object-fit:cover"></span><div><div class="frname" style="font-size:14px;font-weight:800;color:${SL_INK}">${n} <span style="color:${SL_ACCENT}">✔</span></div><div style="font-size:12.5px;color:${SL_SUB}">Verified Buyer</div></div></div></div>`).join('')}</div><span class="frprev" style="position:absolute;left:-12px;top:50%;transform:translateY(-50%);width:42px;height:42px;border-radius:50%;background:#fff;border:1px solid ${SL_LINE};box-shadow:0 2px 10px rgba(20,18,15,.18);display:flex;align-items:center;justify-content:center;color:${SL_INK};font-size:20px;line-height:1;cursor:pointer">‹</span><span class="frnext" style="position:absolute;right:-12px;top:50%;transform:translateY(-50%);width:42px;height:42px;border-radius:50%;background:#fff;border:1px solid ${SL_LINE};box-shadow:0 2px 10px rgba(20,18,15,.18);display:flex;align-items:center;justify-content:center;color:${SL_INK};font-size:20px;line-height:1;cursor:pointer">›</span></div>`, '#faf9ff') },
  ...
  { id: 'reviews-number', label: 'Reviews Number', html: slWrap(`<div class="rnum" style="text-align:center"><div class="stars" style="color:#f5a623;letter-spacing:3px;font-size:24px;margin-bottom:8px">★★★★★</div><div class="rtext" style="font-size:16px;font-weight:700;color:${SL_INK}">Rated <b>4.9/5</b> by 2,340+ happy customers</div></div>`) },
  { id: 'featured-review', label: 'Featured Review', html: slWrap(`<div class="frev" style="max-width:620px;margin:0 auto;background:#fff;border:1px solid ${SL_LINE};border-radius:18px;padding:28px 26px;box-shadow:0 4px 18px -10px rgba(20,18,15,.2)"><div class="stars" style="color:#f5a623;letter-spacing:2px;font-size:17px;margin-bottom:12px">★★★★★</div><p class="frq" style="font-size:17px;line-height:1.6;color:${SL_INK};margin:0 0 16px">"This has completely changed my daily routine — I feel calmer and more focused with every use. Honestly the best purchase I've made this year."</p><div class="frwho" style="display:flex;align-items:center;gap:12px"><span class="avim" style="width:46px;height:46px;border-radius:50%;overflow:hidden;flex:none"><img src="${SL_AVATAR}" alt="" style="width:100%;height:100%;object-fit:cover"></span><div><div class="frname" style="font-size:14px;font-weight:800;color:${SL_INK}">Jessica R. <span style="color:${SL_ACCENT}">✔</span></div><div style="font-size:12.5px;color:${SL_SUB}">Verified Buyer</div></div></div></div>`) },
  { id: 'review-card', label: 'Review Card', html: slWrap(`<div class="rcard" style="max-width:360px;margin:0 auto;background:#fff;border:1px solid ${SL_LINE};border-radius:18px;overflow:hidden;box-shadow:0 4px 18px -10px rgba(20,18,15,.2)"><img src="${SL_PHOTO}" alt="" style="width:100%;height:220px;object-fit:cover;display:block"><div style="padding:20px"><div class="rcwho" style="display:flex;align-items:center;gap:10px;margin-bottom:8px"><span class="avim" style="width:38px;height:38px;border-radius:50%;overflow:hidden;flex:none"><img src="${SL_AVATAR}" alt="" style="width:100%;height:100%;object-fit:cover"></span><div class="rcname" style="font-size:13.5px;font-weight:800;color:${SL_INK}">John Doe <span style="color:${SL_ACCENT}">✔</span></div></div><div class="stars" style="color:#f5a623;letter-spacing:1px;font-size:13px;margin-bottom:8px">★★★★★</div><p class="rcq" style="font-size:14.5px;line-height:1.55;color:${SL_INK};margin:0">"Made for modern eCommerce — fast, practical, and conversion-focused. We simplify the workflow so you can sell more with confidence."</p></div></div>`) },
