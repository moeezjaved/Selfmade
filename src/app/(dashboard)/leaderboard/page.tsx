      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 16, flexWrap: 'wrap' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexWrap: 'wrap' }}>
          ...
          <button onClick={analyzeShifts} disabled={aiLoading || !data?.shifts}
            style={{ display: 'flex', alignItems: 'center', gap: 5, height: 34, padding: '0 13px', borderRadius: 10, border: 'none', background: '#ef4a1e', color: '#fff', fontSize: 13, fontWeight: 800, cursor: aiLoading ? 'default' : 'pointer', fontFamily: FONT, opacity: aiLoading || !data?.shifts ? 0.6 : 1 }}>
