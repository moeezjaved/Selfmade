      ...
      {step==='pixel'&&(
        <div style={card}>
          ...
          <div style={{padding:24}}>
            <div style={{marginBottom:14}}><label style={{display:'block',fontSize:12,fontWeight:700,color:'rgba(255,255,255,0.5)',marginBottom:6,textTransform:'uppercase',letterSpacing:'.06em'}}>Your product / website name</label><input value={(form as any)['product']} onChange={e=>set('product',e.target.value)} placeholder="e.g. HairFallSolution.com" style={{width:'100%',padding:'10px 14px',borderRadius:10,border:'1.5px solid rgba(255,255,255,0.1)',background:'rgba(255,255,255,0.05)',color:'white',fontSize:14,fontFamily:'inherit',outline:'none'}}/></div>
            <div style={{marginBottom:14}}><label style={{display:'block',fontSize:12,fontWeight:700,color:'rgba(255,255,255,0.5)',marginBottom:6,textTransform:'uppercase',letterSpacing:'.06em'}}>What do you sell?</label><textarea value={(form as any)['description']} onChange={e=>set('description',e.target.value)} placeholder="e.g. Hair loss treatment serum for men and women" style={{width:'100%',padding:'10px 14px',borderRadius:10,border:'1.5px solid rgba(255,255,255,0.1)',background:'rgba(255,255,255,0.05)',color:'white',fontSize:14,fontFamily:'inherit',outline:'none',resize:'vertical',minHeight:80,lineHeight:1.6}}></textarea></div>
            <div style={{marginBottom:14}}><label style={{display:'block',fontSize:12,fontWeight:700,color:'rgba(255,255,255,0.5)',marginBottom:6,textTransform:'uppercase',letterSpacing:'.06em'}}>Competitors</label><input value={(form as any)['competitors']} onChange={e=>set('competitors',e.target.value)} placeholder="e.g. Minoxidil, Regaine, Foligain" style={{width:'100%',padding:'10px 14px',borderRadius:10,border:'1.5px solid rgba(255,255,255,0.1)',background:'rgba(255,255,255,0.05)',color:'white',fontSize:14,fontFamily:'inherit',outline:'none'}}/></div>
            <div style={{marginBottom:14}}><label style={{display:'block',fontSize:12,fontWeight:700,color:'rgba(255,255,255,0.5)',marginBottom:6,textTransform:'uppercase',letterSpacing:'.06em'}}>Target customer</label><input value={(form as any)['targetCustomer']} onChange={e=>set('targetCustomer',e.target.value)} placeholder="e.g. Men and women 25-45 experiencing hair thinning" style={{width:'100%',padding:'10px 14px',borderRadius:10,border:'1.5px solid rgba(255,255,255,0.1)',background:'rgba(255,255,255,0.05)',color:'white',fontSize:14,fontFamily:'inherit',outline:'none'}}/></div>
            <div style={{marginBottom:14}}><label style={{display:'block',fontSize:12,fontWeight:700,color:'rgba(255,255,255,0.5)',marginBottom:6,textTransform:'uppercase',letterSpacing:'.06em'}}>Campaign name</label><input value={(form as any)['campaignName']} onChange={e=>set('campaignName',e.target.value)} placeholder="e.g. Hair Fall — M4 — Apr 2025" style={{width:'100%',padding:'10px 14px',borderRadius:10,border:'1.5px solid rgba(255,255,255,0.1)',background:'rgba(255,255,255,0.05)',color:'white',fontSize:14,fontFamily:'inherit',outline:'none'}}/></div>
