        ...
        <>
          ...
          {META_LIVE && (
            <div style={{ background: FOREST, borderRadius: 16, padding: '22px 24px', marginBottom: 18 }}>
              ...
              <a href="/api/meta/init" data-tour="connect-fb" style={{ display: 'inline-flex', alignItems: 'center', gap: 9, background: '#1877F2', color: '#fff', borderRadius: 100, padding: '12px 24px', fontSize: 14.5, fontWeight: 800, textDecoration: 'none' }}>
