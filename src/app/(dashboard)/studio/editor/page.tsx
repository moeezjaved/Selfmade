 ...
 * remake as an editable timeline and plays it live with a free-edit inspector. The editor is loaded
 * client-only (ssr:false) because @remotion/player is browser-only.
 */
