...
export default function StoryboardPage() {
  return (
    <div style={{ maxWidth: 780, margin: '0 auto', padding: '28px 24px 80px' }}>
      <div style={{ fontFamily: "'Helvetica Neue', Helvetica, Arial, sans-serif", fontSize: 11, letterSpacing: '.08em', textTransform: 'uppercase', color: '#6b7a62' }}>Storyboard · before generation</div>
