...
export default function SavedAdsPage() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh', background: '#f8fafc', fontFamily: "'Helvetica Neue', Helvetica, Arial, sans-serif" }}>
              ...
              <button key={board.id} onClick={() => setSelectedBoard(board.id)}
                ...
                {depth === 0 && (board.isMine || board.visibility !== 'team') && (
                  <span onClick={e => { e.stopPropagation(); createSub(board) }} title="Add sub-board"
                    ...
                    onMouseEnter={e => (e.currentTarget.style.color = '#141d15')} onMouseLeave={e => (e.currentTarget.style.color = '#c7cdd4')}>
                    <Plus size={13} />
                  </span>
                )}
                ...
                return (
                  <div key={saved.id} className="animate-fade-up"
                    ...
                    <div style={{ padding: '9px 12px', display: 'flex', alignItems: 'center', gap: 8 }}>
                      <div style={{ width: 26, height: 26, borderRadius: '50%', background: '#141d15', color: '#ff5a2c', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 10, fontWeight: 800, flexShrink: 0 }}>{initials}</div>
                      <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      <button onClick={() => {
                        ...
                        style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#141d15', padding: 0, flexShrink: 0, display: 'flex' }}
                        onMouseEnter={e => (e.currentTarget.style.color = '#d63f16')}
                        onMouseLeave={e => (e.currentTarget.style.color = '#141d15')}>
                        <Sparkles size={13} />
                      </button>
