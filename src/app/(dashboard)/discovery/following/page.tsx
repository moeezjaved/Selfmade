...
export default function FollowingPage() {
  ...
  if (brands.length === 0) return (
    <div style={{ padding: 48, maxWidth: 560, margin: '30px auto', textAlign: 'center' }}>
      ...
      <Link href="/discovery" style={{ display: 'inline-block', marginTop: 6, padding: '10px 18px', background: '#ef4a1e', color: '#fff', borderRadius: 10, fontWeight: 700, fontSize: 14, textDecoration: 'none' }}>Find brands to follow →</Link>
    </div>
  )
