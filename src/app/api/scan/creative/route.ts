...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    // NOTE: product sizing/composition is handled by buildStudioPrompt (the SAME rule production Studio uses
    // — "size the product realistically… roughly a quarter of the frame"). Don't add a competing hint here.
