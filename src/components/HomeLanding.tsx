  ...
  return (
    <div style={{ fontFamily: "'Inter', -apple-system, sans-serif", color: INK, background: '#fff', overflowX: 'hidden' }}>
      ...
      <section id="compare" style={{ ...wrap, padding: '30px 24px 60px' }}>
        ...
        <p style={{ textAlign: 'center', color: '#6b7280', margin: '0 0 32px' }}>Others sell one slice — research <i>or</i> analytics <i>or</i> generation — and some tax your ad spend. Selfmade is the whole loop: spy → remake → launch, at one flat price. <b>No spend caps, no spend tax, ever.</b></p>
