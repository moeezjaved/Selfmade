...
const CARDS: Card[] = [
  { id: 'free', tier: 'Free', price: '$0', per: '', note: 'No card needed',
    feats: ['75 free credits to start (~5 image ads)', '1 brand · 1 competitor to spy on', 'Browse Discovery + Brand Spy + remake ads', 'Daily brief from Mello', 'Solo workspace — 1 seat'], cta: 'Start free' },
