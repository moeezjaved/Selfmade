    ...
    <svg width={size} height={size} viewBox="0 0 160 160" style={{ flexShrink: 0, display: 'block' }}
      ...
      <defs>
        <linearGradient id={gid} x1="0" y1="0" x2="0" y2="1">
          <stop offset="0" stopColor="#f2622c" /><stop offset="1" stopColor="#ef4a1e" />
        </linearGradient>
      </defs>
      ...
      {state === 'delivered' ? (
        ...
        <g stroke="rgba(255,255,255,.7)" strokeWidth="8.5" strokeLinecap="round">
          <path d="M47 85h24" /><path d="M89 85h24" />
        </g>
      ) : (
        /* awake, watching */
        <g fill="#fff"><circle cx="59" cy="83" r="11.5" /><circle cx="101" cy="83" r="11.5" /></g>
      )}
    </svg>
  )
}
