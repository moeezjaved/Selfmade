  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '18px 28px', maxWidth: 1200, margin: '0 auto' }}>
      ...
      <div style={{ display: 'flex', gap: 14, alignItems: 'center' }}>
        ...
        <Link href="/hire" style={{ fontSize: 12.5, fontWeight: 800, color: '#17251c', textDecoration: 'none', background: '#dffe95', borderRadius: 100, padding: '8px 16px' }}>Hire Mello</Link>
      </div>
    </div>
  )
}
