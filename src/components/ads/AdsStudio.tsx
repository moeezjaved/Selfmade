...
const AD_FORMULAS: AdFormula[] = [
  { key: 'outcome', title: 'Sell the outcome', example: '“Olive oil that makes dinner taste like Italy.”',
    prompt: 'Feature my product. Make an ad whose HEADLINE sells the outcome — name the felt result my customer wants, the feeling or transformation my product delivers (in the spirit of "olive oil that makes dinner taste like Italy"), grounded in what my product genuinely does. This is about the COPY angle only: my actual product MUST still be clearly shown and featured in the image (as a hero object or held in-hand), never hidden or omitted. Warm, aspirational, editorial styling.' },
