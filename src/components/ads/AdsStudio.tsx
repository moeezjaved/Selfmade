...
const AD_FORMULAS: AdFormula[] = [
  ...
  { key: 'usecase', title: 'Show the use case', example: '“Cracked one before my long run — didn’t cramp once.”',
    prompt: 'Make an ad showing a specific USE CASE — a real moment with a testimonial-style line about exactly when and why someone reaches for my product (in the spirit of "cracked one before my long run, didn\'t even cramp once"). My actual product must be prominent and clearly visible in the foreground, held or in active use, rendered EXACTLY like its reference photo (never shrunk into a small prop or morphed into another object). Authentic UGC feel with a handwritten highlight; make the when and the why instantly obvious.' },
