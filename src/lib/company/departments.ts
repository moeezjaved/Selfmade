...
export const DEPARTMENTS: Department[] = [
  ...
  },
  {
    ...
    role: 'Answers everyone, turns interested chats into sales, angry reviews into loyalty.',
    personality: 'Never sleeps on a DM.',
    live: true, taskKinds: [],
    responsibilities: [
      { label: 'Unified inbox (IG + WhatsApp + email)', built: true },
      { label: 'Triage + drafted reply (approve to send)', built: true },
      ...
      { label: 'UGC creator find → outreach → ship pipeline', built: true },
